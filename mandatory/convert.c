...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/20 21:34:32 by mazaroua          #+#    #+#             */
/*   Updated: 2023/06/20 21:37:10 by mazaroua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int	get_color_in_texture(t_cub *cub, int Y, \
double w_height, t_tx *tx)
{
	int				x;
	int				y;
	unsigned int	color;
